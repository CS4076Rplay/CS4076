...
#include "C:/Users/mitta/Desktop/Planet_Invasion/clickableqlabel.h"
...
QT_MOC_LITERAL(3, 25, 3), // "Hp*"
QT_MOC_LITERAL(4, 29, 7) // "Weapon*"

    },
    "ClickableQLabel\0clicked\0\0Hp*\0Weapon*"
};
...
void ClickableQLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->clicked((*reinterpret_cast< Hp*(*)>(_a[1]))); break;
        case 2: _t->clicked((*reinterpret_cast< Weapon*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ClickableQLabel::*)(Hp * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickableQLabel::clicked)) {
                *result = 1;
                return;
            }
        ...
        {
            using _t = void (ClickableQLabel::*)(Weapon * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickableQLabel::clicked)) {
                *result = 2;
                return;
            }
...
// SIGNAL 1
void ClickableQLabel::clicked(Hp * _t1)
{
...
// SIGNAL 2
void ClickableQLabel::clicked(Weapon * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
