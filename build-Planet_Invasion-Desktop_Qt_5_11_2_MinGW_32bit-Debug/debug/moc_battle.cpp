...
#include "C:/Users/mitta/Desktop/Planet_Invasion/battle.h"
...
QT_MOC_LITERAL(1, 7, 12), // "attackResult"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 7) // "Player*"

    },
    "Battle\0attackResult\0\0Player*"
};
...
void Battle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->attackResult((*reinterpret_cast< Player*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Battle::*)(Player * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battle::attackResult)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Battle::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Battle.data,
...
// SIGNAL 0
void Battle::attackResult(Player * _t1)
{
